...
def evolve(ham, psi, theta=1, num_threads=None):
    ...
    The implementation applies Pauli terms directly to the state vector and
    evaluates the exponential action with adaptive scaling and a truncated
    Taylor series. It never constructs the dense Hamiltonian or its exponential.
