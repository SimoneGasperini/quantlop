...
class Hamiltonian(_Hamiltonian):
    ...
    This representation lets :func:`quantlop.evolve_higham` and
    :func:`quantlop.evolve_krylov` apply the unitary evolution generated by
    :math:`H` to a state vector :math:`|\psi\rangle` without materializing the
    Hamiltonian matrix.
